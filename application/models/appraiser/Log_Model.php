...
class Log_Model extends CI_Model {
    ...
    {
        $this->db->select('*,app.app_id as app_id,app.app_name as app_name,app2.app_id as app2_id,app2.app_name as app2_name, at.at_id as at_id, at.at_name AS at_name, at2.at_id as at2_id, at2.at_name AS at2_name, at3.at_id AS at3_id, at3.at_name AS at3_name, cl.cl_id AS cl_id, cl.cl_name AS cl_name, cl2.cl_id AS cl2_id, cl2.cl_name AS cl2_name');
        $this->db->from('order');
