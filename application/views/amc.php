        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h5 class="mb-4">Add New AMC</h5>
                            <form action="<?php echo base_url(); ?>Amc/create" method="post">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <h5 class="mb-4" style="display: inline;">AMC List</h5>
                            ...
                            <table id="Table_Order">
                                ...
                                <?php
                                    foreach ($amc_list as $amc) { ?>           
                                        ...
                                        <div id="deleteModal<?php echo $amc->amc_id; ?>" class="modal fade" role="dialog">
                                            <div class="modal-dialog">
                                                <!-- Modal content-->
                                                <div class="modal-content">
                                                    <div class="modal-body text-center">
                                                    <form method="post" action="<?php echo base_url(); ?>Amc/delete/<?php echo $amc->amc_id; ?>">
                                        ...
                                        <div id="editModal<?php echo $amc->amc_id; ?>" class="modal fade" role="dialog">
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?php echo base_url(); ?>Amc/update/<?php echo $amc->amc_id; ?>" method="post">
                                                            <div class="form-group">
