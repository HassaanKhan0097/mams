        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card mb-4" >
                        <div class="card-body">
                            <h5 class="mb-4">Search Expensevoucher</h5>
                            <form action="<?php echo base_url(); ?>Accounting/search_app" method="post">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2-single" data-width="100%" name="v_app_id">
                                            <option value=""></option>
                                            <?php
                        ...
                        <div class="card-body">
                            ...
                            <table id="Table_voucher">
                                ...
                                <?php
                                    ...
                                    <tr>
                                    <td class="table_id"><a href="<?php echo base_url(); ?>accounting/voucher_app/<?php echo $v->v_number; ?>/<?php echo $v->v_app_id; ?>"><?php echo  $v->v_number; ?></a></td>
