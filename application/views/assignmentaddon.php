        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h5 class="mb-4">Add New Assignment Addons</h5>
                            <form action="<?php echo base_url(); ?>assignmentaddon/create" method="post">
                                <div class="form-group">
                                    <label>Types</label>
                                    <input type="text" class="form-control" name="ao_name"
                                        placeholder="Enter Types">
                                    <span class="helper-text"><?php echo form_error('ao_name'); ?></span>
                                </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <h5 class="mb-4" style="display: inline;">Assignment Addons List</h5>
                            ...
                            <table id="Table_assignment" class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th>Assignment Addons Id</th>
                                        <th>Assignment Addons</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                ...
                                <?php
                                    foreach ($ass_addon_list as $at) { ?>           

                                        <tr>
                                            <td><?php echo $at->ao_id; ?></td>
                                            <td><?php echo $at->ao_name; ?></td>
                                            <td> <button type="button" class="btn btn-primary mr-2" data-toggle="modal" data-target="#editModal<?php echo $at->ao_id; ?>">Edit</button>&nbsp;<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteModal<?php echo $at->ao_id; ?>">Delete</button> </td>
                                        </tr>


                                        <div id="deleteModal<?php echo $at->ao_id; ?>" class="modal fade" role="dialog">
                                            <div class="modal-dialog">
                                                <!-- Modal content-->
                                                <div class="modal-content">
                                                    <div class="modal-body text-center">
                                                    <form method="post" action="<?php echo base_url(); ?>assignmentaddon/delete/<?php echo $at->ao_id; ?>">
                                        ...
                                        <div id="editModal<?php echo $at->ao_id; ?>" class="modal fade" role="dialog">
                                            <div class="modal-dialog">

                                                <!-- Modal content-->
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Edit Assignment Addons</h4>
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form action="<?php echo base_url(); ?>assignmentaddon/update/<?php echo $at->ao_id; ?>" method="post">
                                                            <div class="form-group">
                                                                <label>Assignment Addons</label>
                                                                <input type="text" class="form-control" name="update_assignment_name" placeholder="Enter Types" value="<?php echo $at->ao_name; ?>">
