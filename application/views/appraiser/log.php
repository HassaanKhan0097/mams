        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <h5 class="mb-4" style="display: inline;">List of File</h5>
                            ...
                            <table id="Table_files">
                                ...
                                <?php
                                    ...
                                    <tr>
                                    <td class="table_id"><a href="<?php echo base_url(); ?>appraiserpages/Log/logView/<?php echo $ol->order_number; ?>"><?php echo $ol->order_number; ?></a></td>
